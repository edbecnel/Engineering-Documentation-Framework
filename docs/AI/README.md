...
This directory contains the Engineering Documentation Framework guidance for using AI throughout the software development lifecycle. AI tools can accelerate research, planning, documentation, implementation, testing, and review when their roles are clear and project context is well organized.
