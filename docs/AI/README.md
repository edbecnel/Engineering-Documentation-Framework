...
This directory contains the Engineering Documentation Framework guidance for using AI throughout the software development lifecycle.

AI tools can accelerate research, planning, documentation, implementation, testing, and review when their roles are clear and project context is well organized.
...
Developer productivity is part of the cost equation. Saving a small amount of model usage cost is not worthwhile if it creates hours of additional engineering effort, confusion, or rework.
...
- [Developer Handbook](../Developer_Handbook/)
